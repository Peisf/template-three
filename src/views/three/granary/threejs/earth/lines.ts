...
// R:球面半径
export function countryLine(R : Number) {
  const loader = new THREE.FileLoader()// scene.js文件加载类FileLoader：封装了XMLHttpRequest
  ...
  loader.load('/jsons/worldxiuzheng.json', function (data: any) {
